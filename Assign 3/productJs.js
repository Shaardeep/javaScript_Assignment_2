...
productList.forEach((element, i) => {
  const main = document.querySelector("#clothingCards");
  console.log(main);
...
productList2.forEach((element, i) => {
  const main = document.querySelector("#accessories");
  console.log(main);
  ...
  const productCard = `
            ...
            <a href="">
              <div class="img">
                <img
                  src="${productList2[i].preview}"
                  alt=""
                />
              </div>
              <div class="details">
                <h3>${productList2[i].name}</h3>
                <h4>${productList2[i].brand}</h4>
                <h5>Rs ${productList2[i].price}</h5>
              </div>
            </a>
